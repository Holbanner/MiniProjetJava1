...
public class Location implements Serializable {
	...
	public String toString() {
		String res = "Location : " + "\n";
		res += "	Date dï¿½but : " + this.dateDebut.get(Calendar.DAY_OF_MONTH) + "/" + this.dateDebut.get(Calendar.MONTH) + "/" +this.dateDebut.get(Calendar.YEAR) + "\n";
		res += "	Date dï¿½but : " +this.dateFin.get(Calendar.DAY_OF_MONTH) + "/" + this.dateDebut.get(Calendar.MONTH) + "/" +this.dateFin.get(Calendar.YEAR) + "\n";
		res += "	Articles louï¿½ : " + "\n";
